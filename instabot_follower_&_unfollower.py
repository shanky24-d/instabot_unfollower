...
class InstaBot:
    ...
    def get_unfollowers(self):
        self.driver.find_element_by_xpath("/html/body/div[1]/section/main/section/div[3]/div[1]/div/div[2]/div[1]/a".format(self.username))\
            .click()
        sleep(2)
...
my_bot = InstaBot('username','password')  ''' replace your username and password with original one's '''
